...
Keys should be named like 'username.pub', this will create the user 'username' on the bastion server. Usernames containing any non-alphanumeric characters (e.g. `.` or `-`) will be ignored.
